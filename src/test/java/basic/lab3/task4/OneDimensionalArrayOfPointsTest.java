...
public class OneDimensionalArrayOfPointsTest {
    @Test()
    @DisplayName("Logic of class `OneDimensionalArrayOfPoints` should work correctly.")
    void testOneDimensionalArrayOfPoints() throws Exception {
